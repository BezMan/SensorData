...
import com.example.sensordata.ui.screens.SensorCaptureScreen
...
fun AppNavigation() {
    ...
    NavHost(
        ...
        composable(Screen.CheckCondition.route) {
            LightSensorScreen(navController)
        }
        composable(Screen.CaptureSensorData.route) {
            SensorCaptureScreen(navController, myViewModel)
        }
